...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: 20 }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "Usuarios (Sequelize + SQLite + Electron)" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { children: users.map((u) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
      u.name,
      " - ",
      u.email
    ] }, u.id)) })
